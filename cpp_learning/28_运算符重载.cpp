...
//	Cstudent cTom;
//
//	cTom + 24;		// 当没有定义运算符重载时，编译报错；定义运算符重载后，会执行到对应的运算符重载函数
//	//24 + cTom;	// "+"左右两边的变量类型，需要和运算符重载函数一一对应
